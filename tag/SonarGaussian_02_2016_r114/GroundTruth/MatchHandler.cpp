...
//    Drawing::drawDescriptorColor(bgrImg2,&sd2,Scalar(0,255,0),Scalar(0,255,0));
    ...
    Drawing::drawDescriptorColor(temp,&sd2,Scalar(0,255,0),Scalar(0,255,0));
    resize(temp,temp,Size(900,500));
    imshow("Graph", temp);
    cout << "Number of Edges = " << sd2.numberOfEdges() << endl;
    cout << "Number of Vertexes = " << sd2.gaussians.size() << endl;
    ...
    Drawing::drawVertecesMatchs(bgrImg1,bgrImg2,
                                    sd1,sd2,
                                    matchInfo,2);
