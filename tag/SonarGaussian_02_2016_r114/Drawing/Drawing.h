...
public:
    ...
    static const Scalar color[12]; /**< It's a color palette used by some drawing methods */
     ...
     * @param matchInfo - Informations about the match.
     ...
     */
    static void drawVertecesMatchs(Mat bgrImg1, Mat bgrImg2,
