#include "GMBrutalForce.h"

GMBrutalForce::GMBrutalForce()
{
}

void GMBrutalForce::brutalFORCExplore(vector<GraphLink *> &u,
...
void GMBrutalForce::brutalFORCEEdgeConfigCompare(vector<GraphLink *> &u, vector<PFPUU> &uExp, vector<GraphLink *> &v, vector<PFPUU> &vExp)
{
...
void GMBrutalForce::brutalFORCECompare(vector<GraphLink *> &u,
                                       vector<vector<vector<PFPUU> > > &uExp,
...
void GMBrutalForce::brutalFORCE(vector<GraphLink *> &u, vector<GraphLink *> &v)
{
    vector< vector<
            pair<
                float,
